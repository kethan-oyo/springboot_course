...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private final ResponseEntity<Object> handleUserNameNotFoundException(UserNameNotFoundException ex, WebRequest request){
    ...
    private final ResponseEntity<Object> handleConstraintViolationException(ConstraintViolationException ex, WebRequest request){
