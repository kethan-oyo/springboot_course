...
public class UserMappingJacksonController {
    ...
    @GetMapping("/{id}")
    public MappingJacksonValue getUserById(@PathVariable("id") @Min(value = 1) Long id) {
        try {
    ...
    public MappingJacksonValue getUserById2(@PathVariable("id") @Min(value = 1) Long id, @RequestParam Set<String> fields){
        try {
